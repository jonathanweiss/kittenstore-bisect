    ...
    <div>
      ...
      <Switch>
        ...
        <Route
          exact
          path="/"
          render={() => <Homepage amountOfProducts={3} products={cats} />}
        />
        <Route
          exact
          path="/catfood"
        ...
        <Route
          ...
          render={() => (
            <Category
              desc={categories.cats.desc}
              items={categories.cats.items}
            />
          )}
        />
        ...
        <Route
          ...
          render={({ match }) => (
            <Detail slug={match.params.catName} data={cats} displayRelated />
          )}
        />
        ...
        <Route
          path="/search/:term"
          render={({ match }) => (
            <SearchResult term={match.params.term} data={cats} />
          )}
        />
